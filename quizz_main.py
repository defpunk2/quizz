...
class quizz:
    ...
    def choice(self):
        ...
        play_btn = tk.Button(master=window,text = "Play Classic True or False", command = self.homeQuizz,width = 45,height=15,bg = "DodgerBlue4", font= 'Impact 20',fg =  "white")
    ...
    def editQuizz(self):
        ...
        if self.x % 2 == 0:
            ...
            buttonF = tk.Button(window, text="True", command= self.trueEnter,width = 45,height=20,bg = "green",font= 'Impact 17',fg =  "white")
            buttonT = tk.Button(window, text="False", command= self.falseEnter,width = 45,height=20,bg = "red",font= 'Impact 17',fg =  "white")
            buttonF.place(x=450,y=300)
            buttonT.place(x=1150,y=300)
    ...
    def creationStation(self):
        ...
        if self.x != 12:
            ...
            title = tk.Label(master=window,text ="Your Quiz Has Been Created",fg = "gray13", font= 'Impact 35',bg = self.bg)
            title.place(x=800,y=200)
            back_btn = tk.Button(master=window,text = "<-", command = self.createEdit,width = 5,height=1,bg = "gray1",font= 'Impact 17',fg =  "white")
            back_btn.place(x=1700,y=50)
